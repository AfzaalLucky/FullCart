...
using FullCart.Infrastructure.Helpers;
        ...
        public async Task<Response<string>> RegisterAsync(RegisterRequest request, string origin)
        {
            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await emailService.SendAsync(new Application.DTOs.Email.EmailRequest() { From = "noreply@atelbpo.com", To = user.Email, Body = $"Please confirm your account by visiting this URL {verificationUri}", Subject = "Confirm Registration" });
